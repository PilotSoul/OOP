...
public class WorkString {
    ...
    public void getNew_str() {
        System.out.println("После удаления слов,начинающихся и оканчивающихся на разные буквы, получилась такая строка: " + createNew_str());
    }
    ...
    public void getTotal(){
        if (countTotal() > 0)
            System.out.println("Количество знаков препинания в тексте: " + countTotal());
        else
            System.out.println("Увы, в заданном тексте мне не удалось найти знаки препинания");
    }
    ...
    public void setFStr(String new_text){
        this.text = new_text;
    }
}
